...
[<img src="/images/e2e/playwright_ui.avif" width="1200" height="319" loading="lazy" alt="ImgCompress Playwright E2E interactive UI mode dashboard showing automated browser test execution on macOS">](/images/e2e/playwright_ui.avif){ aria-label="View Playwright E2E interactive UI mode" }
