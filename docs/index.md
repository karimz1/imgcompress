...
hero_secondary_button_link: "https://hub.docker.com/r/karimz1/imgcompress"
---

<div class="product-section" style="text-align: center;">
  <div class="section-label">AI Magic</div>
  <h2 class="section-title">AI Background Removal (Offline & Private)</h2>
...
<div class="feature-grid">
  ...
  <div class="feature-card">
    ...
    <h3>Local AI</h3>
    <p>Use powerful AI to remove backgrounds without any cloud dependency. Everything stays on your hardware.</p>
  </div>
  <div class="feature-card">
    <div class="feature-icon"><i class="fa-solid fa-file-export"></i></div>
    <h3>Universal Formats</h3>
    <p>Convert between 70+ formats including <strong>AVIF, WebP, HEIC, PSD, and PDF</strong> with ease.</p>
  </div>
  <div class="feature-card">
