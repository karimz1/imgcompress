...
export const ar: TranslationSchema = {
  ...
  form: {
    ...
    pdfQuality: {
      label: "جودة المستند",
      tooltip:
        "قيمة DPI الأعلى تجعل الصور أكثر وضوحًا لكنها تزيد أيضًا حجم ملف PDF.\nاختر إعدادًا أقل عندما تحتاج ملفًا صغيرًا للمشاركة، وإعدادًا أعلى عند الطباعة.",
      options: {
        small: "منخفضة · 96 DPI",
        medium: "قياسية · 150 DPI",
        high: "عالية · 220 DPI",
        ultra: "قصوى · 300 DPI",
      },
      hints: {
        small: "أصغر حجم للملف. مثالية للإرسال السريع عبر البريد الإلكتروني.",
        medium: "حجم ملف صغير. مثالية للقراءة على الشاشة.",
        high: "حجم ملف أكبر. لطباعة حادة وواضحة.",
        ultra: "أكبر حجم للملف. أقصى حدة للأرشفة والطباعة الاحترافية.",
      },
    },
    pdfScale: {
      label: "وضع مقياس PDF",
